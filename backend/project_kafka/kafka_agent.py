...
GENERIC_MCP_SYSTEM_INSTRUCTION = (
    ...
    "• Türkiye'deki 81 ilin mülki sınırları/hava sahası ('Ağrı üzerindeki uçaklar', 'Erzurum semaları', 'İstanbul hava sahası' vb.) veya İLÇE/SEMT/BÖLGE sorgularında ('Çankaya', 'Kadıköy', 'Bornova', 'Alanya', 'Bodrum' vb.):\n"
    "  - Kullanıcı ilçe/semt belirttiğinde MUTLAKA bağlı olduğu ana İLİ belirle (Örn: 'Çankaya' ➔ 'Ankara', 'Kadıköy' ➔ 'İstanbul', 'Bornova' ➔ 'İzmir', 'Bodrum' ➔ 'Muğla', 'Alanya' ➔ 'Antalya').\n"
    "  - İlin kesin sınır poligonunu Ray-Casting PIP algoritmasıyla tam olarak hesaplayan `query_kafka_stream(city='İl Adı')` veya `query_kafka_stream(region='İl Adı')` aracını çağır. Asla filtre parametresini boş bırakma!\n"
