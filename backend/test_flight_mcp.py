...
async def main():
    ...
    async with streamable_http_client(MCP_URL) as (read_stream, write_stream):
        async with ClientSession(read_stream, write_stream) as session:
            ...
            print("\n" + "=" * 60)
            print("1️⃣ [MCP TEST] Calling get_kafka_stream_stats()...")
            ...
            # 3. Test get_flights_above_speed
            print("\n" + "=" * 60)
            print("2️⃣ [MCP TEST] Calling get_flights_above_speed(min_speed_kmh=900, limit=2)...")
            ...
            print("\n" + "=" * 60)
            print("3️⃣ [MCP TEST] Calling search_airline_from_kafka(airline_code='TK', limit=2)...")
